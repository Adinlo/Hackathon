...
def eval_nn(individual, input_dim, output_dim, X_train, y_train, X_test, y_test):
    ...
    # Pénaliser le nombre de couches et de neurones
...
def run_genetic_algorithm(filepath, n_population=10, n_generations=10):
    ...
    for gen in range(n_generations):
        ...
        # Ajouter des individus aléatoires pour la diversité
        ...
        # Forcer la diversité dans les structures de 1 et 2 couches
        ...
        for ind in population:
            ...
            if len(structure) == 1 and ind.accuracy >= 0.98:
                ...
                display_best_individual(best_ind, X_train.shape[1])
                break
    ...
    # Afficher les graphes pour l'accuracy et le loss au cours des générations
    plt.figure(figsize=(12, 5))
...
filepath = 'iris.csv'  # Remplacez par le chemin de votre fichier CSV
